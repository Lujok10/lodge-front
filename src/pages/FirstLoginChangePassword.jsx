...
export default function FirstLoginChangePassword() {
  ...
  useEffect(() => {
    ...
    // If they don't need to change password, route them away
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post("/auth/first-login-change-password", { newPassword: pw1 });
    ...
    <div className="ui-card">
      ...
      <div className="ui-card-body">
        <form onSubmit={handleSubmit}>
          ...
          <button className="btn btn-primary w-100 ui-btn" disabled={saving}>
